...
(see [the Getting started example]({% link ./getting_started/getting_started.md %}#the_optimization_task) for more information). 

As the solution space for new designs is limited it is not 
